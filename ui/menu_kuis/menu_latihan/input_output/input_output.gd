...
@onready var papan_inout = $background/papanMenu/papanInout
...
func _ready():
	...
	papan_inout.position.y = -200
	papan_inout.scale = Vector2(1, 1)
...
func animasi_masuk():
	...
	tween.tween_property(papan_inout, "position:y", papan_inout.position.y + 210, 0.6).set_trans(Tween.TRANS_BOUNCE).set_ease(Tween.EASE_OUT)
...
func _on_level1_pressed() -> void:
	...
	get_tree().change_scene_to_file("res://maps/inOut/view/level1.tscn")

func _on_level2_pressed() -> void:
	GlobalAudio.play_click()
	await get_tree().create_timer(0.1).timeout
	get_tree().change_scene_to_file("res://maps/inOut/view/level2.tscn")
...
func _on_level4_pressed() -> void:
	GlobalAudio.play_click()
	await get_tree().create_timer(0.1).timeout
	get_tree().change_scene_to_file("res://maps/inOut/view/level4.tscn")

func _on_level5_pressed() -> void:
	GlobalAudio.play_click()
	await get_tree().create_timer(0.1).timeout
	get_tree().change_scene_to_file("res://maps/inOut/view/level5.tscn")
