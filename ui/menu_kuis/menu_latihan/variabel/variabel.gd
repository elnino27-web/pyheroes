...
@onready var papan_variabel = $background/papanMenu/papanVariabel
...
func _ready():
	...
	papan_variabel.position.y = -200
	papan_variabel.scale = Vector2(1, 1)
...
func animasi_masuk():
	...
	tween.tween_property(papan_variabel, "position:y", papan_variabel.position.y + 210, 0.6).set_trans(Tween.TRANS_BOUNCE).set_ease(Tween.EASE_OUT)
...
func _on_level1_pressed() -> void:
	...
	get_tree().change_scene_to_file("res://maps/variabel/view/level1.tscn")
...
func _on_level4_pressed() -> void:
	click.play_click()
	await get_tree().create_timer(0.1).timeout
	get_tree().change_scene_to_file("res://maps/variabel/view/level4.tscn")

func _on_level5_pressed() -> void:
	click.play_click()
	await get_tree().create_timer(0.1).timeout
	get_tree().change_scene_to_file("res://maps/variabel/view/level5.tscn")
