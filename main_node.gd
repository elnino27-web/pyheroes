...
@onready var player: CharacterBody2D = $player  # pastikan child bernama "player"
var target: Vector2 = Vector2.ZERO
var accel: float = 2000.0
var pScene = load("res://Buku.tscn")
var p1 = pScene.instantiate()
...
func gerak_player(delta):
	...
	player.velocity = player.velocity.move_toward(target, accel * delta)
...
func arah_player(gerak):
	...
	var animasi = player.get_node("AnimatedSprite2D") as AnimatedSprite2D
